...
const FAQS = [
  {
    ...
    answer:
      "Most GTA homes do well with two cleanings a year — once in late spring after seed pods drop, and once in late fall after the leaves come down. Homes surrounded by mature trees sometimes benefit from a mid-summer check too.",
  },
  {
    question: "Are your estimates really free?",
    answer:
      "Yes. We'll take a look at your property, talk through what it needs, and give you a clear price before any work begins — no obligation to book.",
  },
  {
    question: "Is T-Rex fully insured?",
    answer:
      "Yes, we carry full liability insurance, and our crews are trained in proper ladder and roof-edge safety on every job.",
  },
  {
    question: "What areas do you service?",
    answer:
      "We serve Toronto and the surrounding GTA, including North York, Scarborough, and Etobicoke. If you're just outside these areas, reach out anyway — we often make exceptions for returning customers.",
  },
  {
    question: "Do I need to be home while you work?",
    answer:
      "Not at all. As long as we can safely access the areas being cleaned, most jobs are completed without you needing to be there.",
  },
  {
    question: "Can I set up a recurring cleaning schedule?",
    answer:
      "Definitely. Many of our clients book us automatically for spring and fall visits every year so they never have to think about it. Just mention it on your quote request and we'll set it up.",
  },
];

// CSS injected once — all animation keyframes live here, no scroll dependency
...
export default function Home() {
  ...
  // Smooth scroll with flash transition for nav links
  function handleNavClick(e: React.MouseEvent<HTMLAnchorElement>, id: string) {
    ...
    requestAnimationFrame(() => {
      setFlashKey(k => k + 1);
      setShowFlash(true);
      // Small delay so flash starts before scroll
      setTimeout(() => {
        target.scrollIntoView({ behavior: "smooth", block: "start" });
      }, 80);
      // Remove flash div after animation
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await fetch("/api/send-email", {
        ...
        body: JSON.stringify({ ...form, service: servicePayload }),
      });
  ...
  return (
    <div className="min-h-screen bg-[#EAE3D3] font-sans text-[#0B1629]">
      ...
      {/* Flash overlay for nav transitions */}
      {showFlash && <div key={flashKey} className="nav-flash" />}
      ...
      <section id="home" className="relative w-full bg-[#0F2040] overflow-hidden py-20 lg:min-h-screen lg:flex lg:items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 flex flex-col justify-center w-full">
          <p className="anim-fade-up inline-flex items-center gap-2 text-[#E09A30] text-xs font-bold uppercase tracking-[0.2em] mb-5" style={{ animationDelay: "0ms" }}>
            <span className="w-6 h-px bg-[#C8882A]" />
            Serving the GTA Since 2007
          </p>
          <h1 className="anim-fade-up text-white font-extrabold text-4xl sm:text-5xl lg:text-6xl leading-tight max-w-3xl mb-6" style={{ animationDelay: "80ms" }}>
            Premium Residential &amp; Commercial{" "}
            <span className="text-[#E09A30]">Window &amp; Eavestrough</span>{" "}
            Maintenance in the GTA
          </h1>
          <p className="anim-fade-up text-slate-300 text-lg sm:text-xl max-w-xl leading-relaxed mb-10" style={{ animationDelay: "160ms" }}>
            Trusted, family-owned &amp; fully insured service — delivered with care and professionalism since 2007.
          </p>
          <div className="anim-fade-up flex flex-col sm:flex-row gap-4 pb-10" style={{ animationDelay: "240ms" }}>
            <a
              href="#estimate"
          ...
          <div className="anim-fade-up flex flex-wrap gap-6 mt-4" style={{ animationDelay: "320ms" }}>
      ...
      <section id="services" className="py-20 sm:py-28 bg-[#EAE3D3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="anim-fade-up mb-14" style={{ animationDelay: "0ms" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICES.map((svc, idx) => (
              <div
                key={svc.title}
                className="anim-fade-up group bg-[#F7F2E7] rounded-2xl shadow-sm hover:shadow-xl border border-[#DDD3BC] hover:border-[#C8882A]/30 p-7 hover:-translate-y-1 transition-transform duration-200"
            ...
            <div
              className="anim-fade-up bg-[#0F2040] rounded-2xl p-7 flex flex-col justify-between"
      ...
      <section id="estimate" className="py-20 sm:py-28 bg-[#0B1629] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="anim-fade-up text-center mb-12" style={{ animationDelay: "0ms" }}>
          ...
          {submitted ? (
            <div className="anim-fade-in bg-[#162B50] rounded-2xl border border-[#1A9E4F]/40 p-12 text-center">
            ...
            <form
              ...
              className="anim-fade-up bg-[#162B50] rounded-2xl border border-white/10 p-8 sm:p-10 shadow-2xl"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={t.name}
                className="anim-fade-up bg-[#F7F2E7] rounded-2xl border border-[#DDD3BC] shadow-sm p-7"
      ...
      <section id="faq" className="py-20 sm:py-28 bg-[#0F2040] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="anim-fade-up mb-14 text-center" style={{ animationDelay: "0ms" }}>
          ...
          <div className="lg:grid lg:grid-cols-[1fr_2fr] lg:gap-16 lg:items-start">
            <div className="hidden lg:flex flex-col gap-6 sticky top-28">
              <div className="anim-fade-up bg-[#162B50] rounded-2xl p-6 border border-white/10" style={{ animationDelay: "80ms" }}>
              ...
              <div className="anim-fade-up bg-[#1A9E4F]/10 border border-[#1A9E4F]/30 rounded-2xl p-6" style={{ animationDelay: "160ms" }}>
            ...
            <div className="space-y-3">
              {FAQS.map((faq, idx) => {
                ...
                return (
                  <div
                    key={faq.question}
                    className="anim-fade-up rounded-xl border border-white/10 bg-[#162B50] overflow-hidden"
                  ...
                  >
                    ...
                    >
                      {faq.question}
                      <span className={`flex-shrink-0 text-[#E09A30] text-2xl leading-none transition-transform duration-300 ${isOpen ? "rotate-45" : "rotate-0"}`}>
                        +
                      </span>
                    </button>
      ...
      {/* ── FOOTER ── */}
      <footer className="anim-fade-in bg-[#0B1629] border-t border-white/10" style={{ animationDelay: "0ms" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10">
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Family-owned, fully insured exterior cleaning services across Toronto and the Greater Toronto Area.
              </p>
            </div>
            <div>
