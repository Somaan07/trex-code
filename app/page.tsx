...
export default function Home() {
  ...
  const estimateReveal = useScrollReveal();
  ...
  return (
    <div className="min-h-screen bg-[#EAE3D3] font-sans text-[#0B1629]">
      ...
      <section
        id="home"
        className="relative w-full bg-[#0F2040] overflow-hidden py-20 lg:min-h-screen lg:flex lg:items-center"
      >
        ...
        >
          ...
          <div className="flex flex-wrap gap-6 mt-4">
            {["Fully Insured", "Family-Owned", "17+ Years Experience", "Free Estimates"].map(
              (badge) => (
                <div
                  key={badge}
                  className="flex items-center gap-2 text-slate-300 text-sm drop-shadow-sm"
                >
                  <CheckIcon />
                  {badge}
                </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    {faq.question}
                    <span
                      className={`flex-shrink-0 text-[#E09A30] text-2xl leading-none transition-transform duration-300 ${
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="text-slate-300 text-sm leading-relaxed px-6 pb-5">
                        {faq.answer}
                      </p>
                    </div>
                  </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10">
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Family-owned, fully insured exterior cleaning services across Toronto and the
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-slate-400">
                {["Toronto", "North York", "Scarborough", "Etobicoke", "Surrounding GTA"].map(
                  (area) => (
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
            <p>
              © {new Date().getFullYear()}&nbsp;T-Rex Window &amp; Eaves Cleaning INC. All
              rights reserved.
            </p>
